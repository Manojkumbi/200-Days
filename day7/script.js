...
dive.className="card";
    dive.innerHTML=`<div class="det">
    <h2>${ element.slno}.${element.name}</h2>
    <p><a href="https://www.google.com/maps/search/${forname}+${formattedAddress}">${element.address}</a></p>
     </div>  
     <div>
       <iframe src="https://www.google.com/maps/embed?pb=!1m16!1m12!1m3!1d3888.385062761012!2d77.50664365!3d12.947194300000001!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!2m1!1s${mapnm}%20${mapadd}!5e0!3m2!1sen!2sin!4v1728369355170!5m2!1sen!2sin" width="400" height="300" style="border:0;" allowfullscreen="false" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
     </div>
      `;
